...
namespace Riemers_Shooter
{
    ...
    public class Game1 : Game
    {
        ...
        private void CreateForeground()
        {
            ...
            _foregroundTexture = new Texture2D(GraphicsDevice, _screenWidth, _screenHeight, false, SurfaceFormat.Color);
        ...
        private void UpdateRocket()
        {
            if (_rocketFlying)
            {
                ...
                if (_rocketPosition.X > _screenWidth || _rocketPosition.Y > _screenHeight)
                {
                    _smokeList.Clear();
                }
                else
        ...
        private void DrawText()
        {
            ...
            _spriteBatch.DrawString(_font, player.Name, new Vector2(20, 20), player.Color);
            _spriteBatch.DrawString(_font, "Cannon angle: " + currentAngle.ToString(), new Vector2(20, 45), player.Color);
            _spriteBatch.DrawString(_font, "Cannon power: " + player.Power.ToString(), new Vector2(20, 70), player.Color);
        }
